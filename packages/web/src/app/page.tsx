...
export default async function Home({ searchParams }: HomeProps) {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-6 gap-8">
      ...
      {user ? (
        <div className="w-full max-w-md flex flex-col gap-5 rounded-2xl border border-white/60 dark:border-white/10 bg-white/70 dark:bg-zinc-900/60 backdrop-blur-md p-6 shadow-xl shadow-orange-500/10">
          ...
          <div className="grid grid-cols-3 gap-2">
            <Link
              href="/shop"
              className="flex flex-col items-center gap-1 rounded-xl bg-gradient-to-br from-amber-400 to-orange-500 hover:from-amber-500 hover:to-orange-600 text-white px-3 py-4 text-sm font-medium shadow-lg shadow-orange-500/25 transition hover:-translate-y-0.5"
            >
        ...
        <a
          href="/api/auth/login"
          className="group inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-amber-400 to-orange-500 hover:from-amber-500 hover:to-orange-600 text-white px-6 py-3 text-sm font-semibold shadow-lg shadow-orange-500/30 transition hover:-translate-y-0.5"
        >
